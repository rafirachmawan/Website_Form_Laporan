...
export default function TambahProjectMingguan() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("masterProjectsMingguan");
    if (saved) {
  ...
  useEffect(() => {
    localStorage.setItem("masterProjectsMingguan", JSON.stringify(projects));
  }, [projects]);
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold mb-6 text-blue-700">
        ➕ Tambah Project Laporan Mingguan
      </h1>
